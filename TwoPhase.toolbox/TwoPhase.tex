...
\@pvspace{8.0pt}%
\@x{ {\EXTENDS} Sequences ,\, Naturals ,\, Integers}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} msgs ,\, rmState ,\, tmState ,\, tmPrepared}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} msgs ,\, rmState ,\, tmState ,\, tmPrepared
 {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ RMs \.{\defeq} \{\@w{rm1} ,\,\@w{rm2} ,\,\@w{rm3} ,\,\@w{rm4}
 ,\,\@w{rm5} ,\,\@w{rm6} ,\,\@w{rm7} ,\,\@w{rm8} ,\,\@w{rm9} \}}%
\@pvspace{8.0pt}%
\@x{ Message \.{\defeq}}%
 \@x{\@s{8.2} [ type \.{:} \{\@w{Prepared} \} ,\, theRM \.{:} RMs ]\@s{4.1}
 \.{\cup}\@s{4.1} [ type \.{:} \{\@w{Commit} ,\,\@w{Abort} \} ]}%
\@pvspace{16.0pt}%
\@x{ Init \.{\defeq}}%
\@x{\@s{8.2} \.{\land} msgs \.{=} \{ \}}%
 \@x{\@s{8.2} \.{\land} rmState \.{=} [ rm \.{\in} RMs \.{\mapsto}\@w{working}
 ]}%
\@x{\@s{8.2} \.{\land} tmState\@s{0.89} \.{=}\@w{init}}%
\@x{\@s{8.2} \.{\land} tmPrepared \.{=} \{ \}}%
\@pvspace{8.0pt}%
\@x{ SndPrepare ( rm ) \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ type
 \.{\mapsto}\@w{Prepared} ,\, theRM \.{\mapsto} rm ] \}}%
\@x{\@s{8.2} \.{\land} rmState [ rm ] \.{=}\@w{working}}%
 ...
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RcvPrepare ( rm ) \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} [ type \.{\mapsto}\@w{Prepared} ,\, theRM \.{\mapsto}
 rm ] \.{\in} msgs}%
\@x{\@s{8.2} \.{\land} tmState \.{=}\@w{init}}%
\@x{\@s{8.2} \.{\land} tmPrepared \.{'} \.{=} tmPrepared \.{\cup} \{ rm \}}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} msgs ,\, tmState ,\, rmState
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SndCommit ( rm ) \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ type
 \.{\mapsto}\@w{Commit} ] \}}%
\@x{\@s{8.2} \.{\land} tmState \.{\in} \{\@w{init} ,\,\@w{commmitted} \}}%
\@x{\@s{8.2} \.{\land} tmPrepared \.{=} RMs}%
\@x{\@s{8.2} \.{\land} tmState \.{'} \.{=}\@w{committed}}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} tmPrepared ,\, rmState
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ RcvCommit ( rm ) \.{\defeq}}%
\@x{\@s{8.2} \.{\land} [ type \.{\mapsto}\@w{Commit} ] \.{\in} msgs}%
 \@x{\@s{8.2} \.{\land} rmState \.{'} \.{=} [ rmState {\EXCEPT} {\bang} [ rm ]
 \.{=}\@w{committed} ]}%
 \@x{\@s{8.2} \.{\land} {\UNCHANGED} {\langle} msgs ,\, tmState ,\, tmPrepared
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ SndAbort ( rm ) \.{\defeq}}%
 \@x{\@s{8.2} \.{\land} msgs \.{'} \.{=} msgs \.{\cup} \{ [ type
 \.{\mapsto}\@w{Abort} ] \}}%
\@x{\@s{8.2} \.{\land} tmState \.{\in} \{\@w{init} ,\,\@w{aborted} \}}%
...
\@pvspace{16.0pt}%
\@x{ Next \.{\defeq}}%
\@x{\@s{16.4} \E\, rm \.{\in} RMs \.{:}}%
\@x{\@s{27.72} \.{\lor} SndPrepare ( rm )}%
\@x{\@s{27.72} \.{\lor} RcvPrepare ( rm )}%
\@x{\@s{27.72} \.{\lor} SndCommit ( rm )}%
\@x{\@s{27.72} \.{\lor} RcvCommit ( rm )}%
\@x{\@s{27.72} \.{\lor} SndAbort ( rm )}%
\@x{\@s{27.72} \.{\lor} RcvAbort ( rm )}%
\@x{\@s{27.72} \.{\lor} SilentAbort ( rm )}%
\@pvspace{8.0pt}%
\@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
\@x{ TypeOK \.{\defeq}}%
\@x{\@s{8.2} \.{\land} msgs \.{\in} {\SUBSET} Message}%
 \@x{\@s{8.2} \.{\land} rmState \.{\in} [ RMs \.{\rightarrow} \{\@w{working}
 ,\,\@w{prepared} ,\,\@w{committed} ,\,\@w{aborted} \} ]}%
 \@x{\@s{8.2} \.{\land} tmState\@s{0.89} \.{\in} \{\@w{init} ,\,\@w{committed}
 ,\,\@w{aborted} \}}%
\@x{\@s{8.2} \.{\land} tmPrepared \.{\in} {\SUBSET} RMs}%
\@pvspace{8.0pt}%
 \@x{ Consistent \.{\defeq} \A\, rm1 ,\, rm2 \.{\in} RMs \.{:} {\lnot} (
