...
THEOREM InductiveProperty == (Inv /\ [Next]_vars) => Inv'
    BY DEF Inv, Next, ProcessRequestFlag, ProcessBeginWaiting, ProcessEnterCritical, ProcessExitCritical, MutualExclusion, TypeOK

\* THEOREM Spec => []MutualExclusion
\* PROOF BY InitProperty, InductiveProperty, SafetyProperty, PTL DEF Inv, Init, Next, MutualExclusion, ProcessRequestFlag, ProcessBeginWaiting, ProcessEnterCritical, ProcessExitCritical

\* Fixed magically
\* THEOREM processState = [i \in {0, 1} |-> "idle"] => Inv
\* ???

\* THEOREM InductiveProperty == Inv /\ [Next]_vars => Inv'
\*    BY DEF Inv, Next, MutualExclusion, TypeOK
    
SpecIndCheck == TypeOk2 /\ Inv /\ [][Next]_vars

=============================================================================
\* Modification History
\* Last modified Wed May 28 13:09:12 EDT 2025 by johnnguyen
