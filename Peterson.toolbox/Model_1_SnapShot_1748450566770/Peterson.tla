...
Inv == /\ TypeOK
       /\ \A p, q \in {0, 1}: \/ processState[p] = "critical" => (flag[q] = FALSE \/ turn = p \/ processState[q] = "sentRequest") 
                              \/ p = q \* removes scenarios which don't properly model the system
       /\ MutualExclusion 
...
THEOREM InitProperty == Init => Inv
    BY DEF Init, Inv, ProcessRequestFlag, ProcessBeginWaiting, ProcessEnterCritical, ProcessExitCritical, TypeOK
...
\* Last modified Wed May 28 12:42:28 EDT 2025 by johnnguyen
