...
THEOREM test == Inv => Safety
    BY DEF Inv, isEven, Safety, Add2, Add6

THEOREM SpecImpliesSafety ==
ASSUME TRUE, InitProperty, InductProperty, test
PROVE Spec => []Safety
BY InitProperty, InductProperty, test, PTL DEF Init, Inv, Next, Safety, Add2, Add6, isEven
=============================================================================
\* Modification History
\* Last modified Wed May 28 17:40:14 EDT 2025 by johnnguyen
