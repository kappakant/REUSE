...
THEOREM InductiveProperty == Inv /\ Next => Inv'
    ...
    <1>b I'
        ...
        \* we'll use the ol' 1-2 punch. Assume arbitrary tm in tmPrepared, and separate arbitrary rm in RMs
        \* use I to prove that it's true in the future.
        <2>a tmPreparedInv'
            <3>1 SUFFICES ASSUME NEW tm \in tmPrepared
                          PROVE /\ (tmState = "init"   => rmState[tm] = "prepared")'
        ...
        <2>. QED BY <2>a, <2>b DEF tmPreparedInv, RMsInv, I
...
\* Last modified Tue Jun 03 00:34:15 EDT 2025 by johnnguyen
