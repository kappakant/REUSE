...
THEOREM PEnCInduction0 == Inv /\ ProcessEnterCritical(0) => Inv'
    ...
    <1>2 MutualExclusion'
        ...
        <2>15 I'
        <2>16 (0#1 /\ processState'[0] = "critical") => flag'[1] = FALSE \/ turn' = 0 \/ processState'[1] = "sentRequest" BY <2>15 DEF I
        <2>17 flag'[1] = FALSE \/ turn' = 0 \/ processState'[1] = "sentRequest" BY <2>1, <2>16
...
\* Last modified Sat May 31 19:19:23 EDT 2025 by johnnguyen
