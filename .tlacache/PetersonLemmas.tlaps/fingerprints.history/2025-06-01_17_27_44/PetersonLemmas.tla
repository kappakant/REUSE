...
THEOREM PEnCInduction0 == Inv /\ ProcessEnterCritical(0) => Inv'
    ...
    \* TODO
    <1>2 MutualExclusion'
        <2>3 SUFFICES ASSUME processState'[0] = "critical" /\ processState'[1] = "critical"
                      PROVE FALSE
        ...
        <2>10 processState[1] = "critical" BY <1>1, <2>3, <2>9 DEF TypeOK
        <2>11 flag[0] = (FALSE \/ turn = 1 \/ processState[0] = "sentRequest") /\ flag[1] = TRUE BY <2>10 DEF Inv, I
        
        <2>12 flag[0] = FALSE \/ turn = 1 BY <2>7, <2>11       
        <2>15 flag[0] = TRUE
        <2>16 turn = 1 BY <2>12, <2>15
        <2>17 flag[1] = FALSE BY <2>8, <2>16
        <2>18 flag[1] = TRUE BY <2>7 DEF Inv, I
        
        
        <2>n processState[1] # "critical"
        <2>n2 processState'[1] # "critical"
        <2>. QED BY <2>n2 DEF MutualExclusion
...
\* Last modified Sun Jun 01 17:27:43 EDT 2025 by johnnguyen
